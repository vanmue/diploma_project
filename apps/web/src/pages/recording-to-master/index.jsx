...
function RecordingToMaster() {
  ...
  return (
    <div className="recording-to-master">
      <div className="recording-to-master__info">
        <div className="recording-to-master__master-info">
          ...
          <img
            ...
            src="https://placehold.co/400x477?text=Фото+мастера"
            alt="Фото"
          />
        </div>
      ...
      <div className="recording-to-master__calendar">
        <img
          className="recording-to-master__img"
          src="https://placehold.co/700x200?text=Часы+записи+для+клиентов"
          alt="Часы для записи"
        />
      </div>
    </div>
