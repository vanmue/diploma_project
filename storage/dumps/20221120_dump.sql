...
(7,	'Barbershop Mens'' House',	'ул. Гагарина, 228',	'8311234567',	45.01,	46.01,	47.01,	48.01,	49,	'2022-11-20 09:26:21.942043',	'2022-11-20 09:26:21.942043',	2,	'с 10:00 до 21:00 без выходных',	10,	21);
...
CREATE TABLE "public"."users" (
    ...
    "created_at" timestamp DEFAULT now() NOT NULL,
    "updated_at" timestamp DEFAULT now() NOT NULL,
    "avatar" character varying DEFAULT '/uploads/users/' NOT NULL,
